...
Besides, there is a function removal script delete-function.sh, which can also serve as an emergency break to stop the execution of lambda function. Normally, it should be enough to delete the corresponding entry in DynamoDB.
